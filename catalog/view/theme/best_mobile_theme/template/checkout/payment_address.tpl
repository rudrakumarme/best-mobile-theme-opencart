<form class="form-horizontal">
  ...
  <div class="smart-radio">
      ...
      <input id="payment_address" type="radio" name="payment_address" value="existing" checked="checked" />
      <label for="payment_address"></label>  <?php echo $text_address_existing; ?>
  </div>
  ...
  <div class="smart-radio">
      ...
      <input id="new_address" type="radio" name="payment_address" value="new" />
     <label for="new_address"></label>  <?php echo $text_address_new; ?> 
  </div>
  <?php } ?>
  <br />
