        ...
        <div id="input-payment-custom-field<?php echo $custom_field['custom_field_id']; ?>">
          ...
          <div class="smart-radio">
            <?php if (isset($guest_custom_field[$custom_field['custom_field_id']]) && $custom_field_value['custom_field_value_id'] == $guest_custom_field[$custom_field['custom_field_id']]) { ?>
              ...
              <input id="<?php echo $custom_field['custom_field_id']; ?>" type="radio" name="custom_field[<?php echo $custom_field['location']; ?>][<?php echo $custom_field['custom_field_id']; ?>]" value="<?php echo $custom_field_value['custom_field_value_id']; ?>" checked="checked" />
              <?php echo $custom_field_value['name']; ?><label for="<?php echo $custom_field['custom_field_id']; ?>"></label>
            <?php } else { ?>
            
              <input id="<?php echo $custom_field['custom_field_id']; ?>" type="radio" name="custom_field[<?php echo $custom_field['location']; ?>][<?php echo $custom_field['custom_field_id']; ?>]" value="<?php echo $custom_field_value['custom_field_value_id']; ?>" />
              <?php echo $custom_field_value['name']; ?><label for="<?php echo $custom_field['custom_field_id']; ?>"></label>
            <?php } ?>
          </div>
          <?php } ?>
...
<div class="checkbox">
    ...
    <input id="shipping_address" type="checkbox" name="shipping_address" value="1" checked="checked" />
    <?php } else { ?>
    <input id="shipping_address" type="checkbox" name="shipping_address" value="1" />
    <?php } ?>
  <label for="shipping_address"></label>  <?php echo $entry_shipping; ?>
</div>
<?php } ?>
<div class="buttons">
