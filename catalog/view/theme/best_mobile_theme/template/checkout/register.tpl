    ...
    <fieldset id="account">
      ...
      <div class="form-group" style="display: <?php echo (count($customer_groups) > 1 ? 'block' : 'none'); ?>;">
        ...
        <div class="smart-radio">
            <input id="customer-group-<?php echo $customer_group['customer_group_id']; ?>" type="radio" name="customer_group_id" value="<?php echo $customer_group['customer_group_id']; ?>" checked="checked" />
            <label for="customer-group-<?php echo $customer_group['customer_group_id']; ?>"></label>  <?php echo $customer_group['name']; ?>
        </div>
        <?php } else { ?>
        <div class="smart-radio">
          
            <input id="customer-group-<?php echo $customer_group['customer_group_id']; ?>" type="radio" name="customer_group_id" value="<?php echo $customer_group['customer_group_id']; ?>" />
            <label for="customer-group-<?php echo $customer_group['customer_group_id']; ?>"></label> <?php echo $customer_group['name']; ?>
        </div>
        <?php } ?>
        <?php } ?>
