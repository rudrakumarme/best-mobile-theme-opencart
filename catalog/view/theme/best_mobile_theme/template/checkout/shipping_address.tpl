<form class="form-horizontal">
  ...
  <div class="smart-radio">
      ...
      <input id="existing" type="radio" name="shipping_address" value="existing" checked="checked" />
      <label for="existing"></label>  <?php echo $text_address_existing; ?>
  </div>
  ...
  <div class="smart-radio">
      ...
      <input id="new_shipping_address" type="radio" name="shipping_address" value="new" />
      <label for="new_shipping_address"></label>  <?php echo $text_address_new; ?>
  </div>
  <?php } ?>
  <br />
      ...
      <div class="col-sm-10">
        <div id="input-shipping-custom-field<?php echo $custom_field['custom_field_id']; ?>">
          ...
          <div class="smart-radio">
              ...
              <input id="<?php echo $custom_field['custom_field_id']; ?>" type="radio" name="custom_field[<?php echo $custom_field['custom_field_id']; ?>]" value="<?php echo $custom_field_value['custom_field_value_id']; ?>" />
             <label for="<?php echo $custom_field['custom_field_id']; ?>"></label>  <?php echo $custom_field_value['name']; ?>
          </div>
          <?php } ?>
        </div>
      </div>
